...
class ResponsesModel extends CI_Model
{
	...
	function insert_tawsil($userID,$teacherID,$studentID, $questID,$examID,$option1,$responseOption1,$option2,$responseOption2,$option3,$responseOption3,$option4,$responseOption4)
	{
	...
	function insert_tartib($userID,$teacherID,$studentID, $questID,$examID,$option1,$responseOption1,$option2,$responseOption2,$option3,$responseOption3,$option4,$responseOption4)
	{
